...
package com.jsongo.ui.component.zxing.camera;
...
import com.jsongo.ui.component.zxing.android.CaptureActivityHandler;
...
//    }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            ...
            int actionbarHeight = QMUIStatusBarHelper.getStatusbarHeight(context);
